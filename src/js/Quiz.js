export default class Quiz {
  ...
  renderShort() {
    if (this.data.number > 4) {
      this.options.forEach((option) =>
        option.classList.add("screen__option_short")
      );
    }
  }
  ...
  renderHandle() {
    ...
    // if (this.data.number < 5) {
      ...
      if (this.data.options[1].isCorrect === "true") {
        ...
        this.option2.querySelector("img").src = "./images/option-wrong.jpg";
      }
    ...
    <div class="screen__content">
      ...
      <div class="screen__main">
        ...
        <div class="screen__buttons">
            <button class="screen__option option-1">${
              this.data.options[0].title
            }
            <img src="./images/option-correct.jpg" alt="" class="screen__option_icon">
            </button>

            <div class="screen__hint hint-1">
              <img src="" alt="" class="screen__icon">
              <p class="screen__hint_text"><span class="screen__hint_right"></span>${
                this.data.options[0].hint
              }</p>
            </div>

            <button class="screen__option option-2">${
            ...
            <div class="screen__hint hint-2">
              <img src="" alt="" class="screen__icon">
              <p class="screen__hint_text"><span class="screen__hint_right"></span>${
                this.data.options[1].hint
              }</p>
            </div>

            <button class="screen__option option-3">${
              this.data.options[2].title
            }
              <img src="" alt="" class="screen__option_icon">
            </button>
            ...
            <div class="screen__hint hint-3">
              ...
              <p class="screen__hint_text"><span class="screen__hint_wrong"></span>${
                this.data.options[2].hint
              }</p>
            </div>

            <button class="screen__option option-4">${
              this.data.options[3].title
            }
              <img src="" alt="" class="screen__option_icon">
            </button>
  ...
  renderComment() {
    if (this.data.number === 2) {
      ...
      <ul>
      <li class="screen__text"><span class="screen__text_span"></span>${this.data.li1}</li>
      <li class="screen__text"><span class="screen__text_span"></span>${this.data.li2}</li>
      <li class="screen__text"><span class="screen__text_span"></span>${this.data.li3}</li>
      <li class="screen__text"><span class="screen__text_span"></span>${this.data.li4}</li>
      </ul>
      `;
    }
